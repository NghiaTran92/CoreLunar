...
public class VietCalendar {
	...
	public static String[] CAN = new String[] { "Giáp", "Ất", "Bính", "�?inh",
			"Mậu", "Kỷ", "Canh", "Tân", "Nhâm", "Quý" };

	public static String[] CHI = new String[] { "Tý", "Sửu", "Dần", "Mão",
			"Thìn", "Tỵ", "Ng�?", "Mùi", "Thân", "Dậu", "Tuất", "Hợi" };
	...
	public static String[] TIET_KHI = new String[] { "Xuân phân", "Thanh minh",
			...
			"�?ại thử", "Lập thu", "Xử thử", "Bạch lộ", "Thu phân", "Hàn lộ",
			"Sương giáng", "Lập đông", "Tiểu tuyết", "�?ại tuyết", "�?ông chí",
			"Tiểu hàn", "�?ại hàn", "Lập xuân", "Vũ Thủy", "Kinh trập" };
	...
	/*
	 * Theo bang 1
	 * https://sites.google.com/site/binhan8289/--trang-tin-tuc-can-biet
	 * /nhung-tin-bai-suu-tam/ngay-goi-hoang-dao---hac-dao
	 */public static DayLunar[][] BANG_HOANG_DAO_HAC_DAO = new DayLunar[][] {
			/* Thang Gieng */
			{
					new DayLunar("Thanh Long", TypeLunarDay.GoodDay, TypeChi.Ty),
					new DayLunar("Minh �?ư�?ng", TypeLunarDay.GoodDay,
							TypeChi.Suu),
					...
					new DayLunar("Bảo Quang (Kim �?ư�?ng)", TypeLunarDay.GoodDay,
							TypeChi.Ti_),
					new DayLunar("Bạch Hổ", TypeLunarDay.BadDay, TypeChi.Ngo),
					new DayLunar("Ng�?c �?ư�?ng", TypeLunarDay.GoodDay,
							TypeChi.Mui),
